...
<body>
    ...
    <div>
        ...
        <section class="position-relative hero-9">
                    ...
                    <div class="row py-7">
                        <div class="col">
                            <h1 class="hero-title fw-bold">
                                Tenemos la solución para tu
                                <span class="highlight highlight-info d-inline-block">industria</span>
                            </h1>
                            <p class="mt-3 fs-17">
                                Nos dedicamos al suministro de una densa variedad de productos
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="position-relative">
                <div class="hero-cta">
                    <a href="/contacto" class="btn btn-info btn-cta">Contactanos</a>
                </div>
            </div>
                ...
                <div class="col-lg-6 offset-lg-1">
                    <div class="img-content2 position-relative mt-4 mt-lg-0">
                        <div class="img-up mb-lg-0 mb-6">
                            <img src="{{asset('/cliente/images/photos/3.jpg')}}" alt="app img" class="img-fluid d-block shadow" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="pt-8 pb-6 mb-4 mt-lg-4 bg-light position-relative" data-aos="fade-up">
        ...
        <div class="container">
            ...
            <div class="row mt-5 text-center">
                ...
                <div class="col-6 col-md-3 mb-4 mb-sm-0">
                    <div class="display-4 fw-normal">
                        $<span data-toggle="counter" data-from="5" data-to="21" data-decimals="0" data-duration="5" data-options='{}'></span>M+
                    </div>
                    <p class="mt-2 mb-0 fw-semibold">
                        Revenue Generated
                    </p>
            ...
            <div class="row mt-5">
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex align-items-center mb-4 pb-md-3">
                        <img src="{{asset('/cliente/images/avatars/img-1.jpg')}}" alt="..."
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex align-items-center mb-4 pb-md-3">
                        <img src="{{asset('/cliente/images/avatars/img-2.jpg')}}" alt="..."
                            class="img-fluid avatar-md d-block rounded me-3" />
                        <div class="flex-grow-1">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex align-items-center mb-4 pb-md-3">
                        <img src="{{asset('/cliente/images/avatars/img-3.jpg')}}" alt="..."
                            class="img-fluid avatar-md d-block rounded me-3" />
                        <div class="flex-grow-1">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex align-items-center mb-4 pb-md-3">
                        <img src="{{asset('/cliente/images/avatars/img-4.jpg')}}" alt="..."
                            class="img-fluid avatar-md d-block rounded me-3" />
                        <div class="flex-grow-1">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex align-items-center mb-4 pb-md-3">
                        <img src="{{asset('/cliente/images/avatars/img-5.jpg')}}" alt="..."
                            class="img-fluid avatar-md d-block rounded me-3" />
                        <div class="flex-grow-1">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex align-items-center mb-4 pb-md-3">
                        <img src="{{asset('/cliente/images/avatars/img-6.jpg')}}" alt="..."
                            class="img-fluid avatar-md d-block rounded me-3" />
                        <div class="flex-grow-1">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex align-items-center mb-4 pb-md-3">
                        <img src="{{asset('/cliente/images/avatars/img-7.jpg')}}" alt="..."
                            class="img-fluid avatar-md d-block rounded me-3" />
                        <div class="flex-grow-1">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="d-flex align-items-center mb-4 pb-md-3">
                        <img src="{{asset('/cliente/images/avatars/img-8.jpg')}}" alt="..."
                            class="img-fluid avatar-md d-block rounded me-3" />
                        <div class="flex-grow-1">
    ...
    <section class="py-5 mb-lg-6 position-relative" data-aos="fade-up">
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col">
                    <img src="{{asset('/cliente/images/brands/amazon.svg')}}" alt=""  height="45"/>
                </div>
                <div class="col offset-1">
                    <img src="{{asset('/cliente/images/brands/google.svg')}}" alt="" height="45"/>
                </div>
                <div class="col offset-1">
                    <img src="{{asset('/cliente/images/brands/paypal.svg')}}" alt="" height="45"/>
                </div>
                <div class="col offset-1">
                    <img src="{{asset('/cliente/images/brands/shopify.svg')}}" alt="" height="45"/>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- back to top -->
    <a class="btn btn-info shadow-none btn-icon btn-back-to-top" href='#'><i class="icon-xxs" data-feather="arrow-up"></i></a>
