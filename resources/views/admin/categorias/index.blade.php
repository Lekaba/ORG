            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-2">
                    <ol class="breadcrumb float-md-left">
                        <a class="btn btn-primary btn-md" href="{{ route('categorias.create') }}"><i class="fas fa-plus-circle"></i>
                    ...
                    <table id="example1" class="table table-bordered table-striped"
                        ...
                        <tbody>
                            ...
                            @foreach ($categorias as $categoria)
                                <tr class="odd">
                                    <td class="text-center" class="dtr-control sorting_1" tabindex="0">{{ $categoria->nombre }}</td>
                                    <th class="text-center" class="row">
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <a class="btn btn-md btn-success" href="{{ route('categorias.edit', $categoria->id) }}"><i
                                                    class="fa fa-eye" aria-hidden="true"></i>
                                            </a>
                                            <a class="btn btn-md btn-danger" href="{{ route('categorias.destroy', $categoria->id) }}"
