...
<body>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-7 text-center">
                        <h1 class="hero-title mb-0">Contactanos</h1>
    ...
    <!-- Contact us start -->
    <section class="section pb-lg-7  position-relative">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="card shadow-none">
                        <div class="card-body p-xl-5 p-0">
                            <h2 class="mb-2 mt-0 fw-medium">Estaremos esperando tu mensaje</h2>
                            <p class="mb-5">Comniquese via telefonica o por correo electronico:</p>

                            <p class="mb-2"><b>CEO:</b> Ramon Valles
                                <h5 class="mb-1">Correo: lkahdflkasjhdfal@orgai.com</h5>
                                <h5 class="mb-1">Telefono: (667) 647 6614</h5>
                            </p>
                ...
                <div class="col-lg-5 offset-lg-1">
                    <div style="height: 520px">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d385.4227149278793!2d-110.97305576967248!3d29.10395787808155!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x86ce842015619a7d%3A0xb5b2a4de1bb3b926!2sRafaela%20Rodr%C3%ADguez%20288%2C%20Balderrama%2C%2083180%20Hermosillo%2C%20Son.!5e0!3m2!1ses!2smx!4v1661122692369!5m2!1ses!2smx" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-5 align-items-center">
                <div class="col-md-4">
                    <div class="d-flex px-md-1 px-lg-5 mb-md-0 mb-3">
                        <span class="bg-soft-primary avatar avatar-sm rounded icon icon-with-bg icon-xs text-primary me-3 flex-shrink-0">
                            <?xml version="1.0" encoding="UTF-8"?>
                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <!-- Generator: Sketch 52.2 (67145) - http://www.bohemiancoding.com/sketch -->
                ...
                <div class="col-md-4">
                    <div class="d-flex px-md-1 px-lg-5 mb-md-0 mb-3">
                        <span class="bg-soft-orange avatar avatar-sm rounded icon icon-with-bg icon-xs text-orange me-3 flex-shrink-0">
                            <?xml version="1.0" encoding="UTF-8"?>
                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <!-- Generator: Sketch 52.2 (67145) - http://www.bohemiancoding.com/sketch -->
                ...
                <div class="col-md-4">
                    <div class="d-flex px-md-1 px-lg-5 mb-md-0 mb-3">
                        <span class="bg-soft-info avatar avatar-sm rounded icon icon-with-bg icon-xs text-info me-3 flex-shrink-0">
                            <?xml version="1.0" encoding="UTF-8"?>
                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <!-- Generator: Sketch 52.2 (67145) - http://www.bohemiancoding.com/sketch -->
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    ...
                    <p class="text-muted mb-4 w-50">On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized.</p>
                </div>
    ...
    <!-- javascript -->
    <!-- vendor js -->
    <script src="{{asset('/cliente/js/vendor.min.js')}}"></script>
